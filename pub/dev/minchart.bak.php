...
?>
	...
	<?php } ?>	
		...
		<div id="main_full">    
			<h2>Minute chart</h2>
				<div>
				<form method="get" accept-charset="utf-8"  action="minchart.php">
				Instrument:
				<?php 
				...
				<select id="ticker" name="ticker">
                    ...
                    $optionlist = array();
                    /*
                    $optionlist []= "00DSEGEN"; $optionlist []= "00DSETO";
                    
                    //first collect the sectors
                    $query = 'SELECT sector_name FROM sectors WHERE s_id > 0 ORDER BY sector_name ASC';
